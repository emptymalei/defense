...
\begin{figure}
    ...
    \caption*{Castle wall matter profile: \\ $\Lambda_2 =0.7\omega_{\mathrm v} \cos 2\theta_{\mathrm v} $ \\  $\Lambda_1 = 0.3\omega_{\mathrm v} \cos 2\theta_{\mathrm v}$\\ period $X =2\pi/\omega_{\mathrm m}$  }
\end{figure}
